...
public class Constants {
    ...
    public static final Integer TEACHER_START_LESSON_TIME_IS_UNTIL = 30;
    public static final Integer TEACHER_END_LESSON_TIME_STARTS_FROM = 30;
    public static final Integer STUDENT_CAN_JOIN_SESSION_UNTIL = 30;
    public static final Integer STUDENT_CAN_LEFT_SESSION_FROM = 30;
